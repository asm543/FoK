    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgbtn_festival_hot1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent Intent = new Intent(MapGyeongsangnamdoActivity.this, DetailtourActivity.class);
        ...
        btn_map.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                // 커스텀 리스트 뷰 창으로 이동
                Intent intent = new Intent(MapGyeongsangnamdoActivity.this,MapMainActivity.class);
                startActivity(intent);
            }
        });
        btn_home.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                // 커스텀 리스트 뷰 창으로 이동
                Intent intent = new Intent(MapGyeongsangnamdoActivity.this,MainActivity.class);
                startActivity(intent);
            }
        });
        ...
        btnsearch.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                // 커스텀 리스트 뷰 창으로 이동
                Intent intent = new Intent(MapGyeongsangnamdoActivity.this,ListViewActivity.class);
