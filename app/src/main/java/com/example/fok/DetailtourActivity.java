...
public class DetailtourActivity extends FontActivity {
...
//                                        intoImageView(seasonthumbnailImage3,button3);
    ...
    private String Parse_Data_Intro() {
        ...
        try {
            URL url = new URL("http://api.visitkorea.or.kr/openapi/service/rest/KorService/detailIntro?ServiceKey="+ MYKEY + "&contentId="+ContentID + "&contentTypeId=12&MobileOS=ETC&MobileApp=FOK"
            );
            XmlPullParserFactory parserCreator = XmlPullParserFactory.newInstance();
            XmlPullParser parser = parserCreator.newPullParser();
    ...
    private String Parse_Data_Info() {
        ...
        try {
            URL url = new URL("http://api.visitkorea.or.kr/openapi/service/rest/KorService/detailInfo?ServiceKey="+MYKEY +"&contentId="+ContentID +"&contentTypeId=12&MobileOS=ETC&MobileApp=FOK"
            );
            XmlPullParserFactory parserCreator = XmlPullParserFactory.newInstance();
            XmlPullParser parser = parserCreator.newPullParser();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detailtour);
...
//                        "행사 위치 : " + addr1 + "\n주최 : " + sponsor1 + "\n주관 : " + sponsor2 + "\n연락처 : " +tel + "(" + telname + ")");
        ...
        btn_map.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                // 커스텀 리스트 뷰 창으로 이동
                Intent intent = new Intent(DetailtourActivity.this,MapMainActivity.class);
        ...
        btn_home.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                // 커스텀 리스트 뷰 창으로 이동
                Intent intent = new Intent(DetailtourActivity.this,MainActivity.class);
                startActivity(intent);
            }
        });
        ...
        btnsearch.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                // 커스텀 리스트 뷰 창으로 이동
                Intent intent = new Intent(DetailtourActivity.this,ListViewActivity.class);
        ...
        imgbtn_detail_hot1.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view) {
                Intent Intent = new Intent(DetailtourActivity.this, DetailActivity2.class);
